...
public class FieldsIgnorer {
    ...
    public static JsonElement findPaths(Gson gson, Object object, Set<String> pathsToFind) {
        ...
        if (object != null && (Set.class.isAssignableFrom(object.getClass()) || Map.class.isAssignableFrom(object
				.getClass()))) {
    ...
    private static JsonElement sortArray(JsonElement jsonElement) {
        TreeSet<JsonElement> orderedSet = newTreeSet(Comparator.comparing(JsonElement::toString));
