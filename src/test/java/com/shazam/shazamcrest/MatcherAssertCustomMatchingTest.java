...
public class MatcherAssertCustomMatchingTest {
    ...
    public void failsWhenCustomMatcherDoesNotMatchOnPrimitive() {
        ...
        assertThrows(AssertionError.class, () -> assertThat(actual, sameBeanAs(expected).with("childBean" + "" +
                ".childString", equalTo("kiwi"))));
    }
    ...
    public void matchesFieldWithChainOfCustomMatchers() {
        ...
        ParentBean.Builder actual = parent().childBean(child().childString("banana").childInteger(2)).parentString
                ("strawberry");

        assertThat(actual, sameBeanAs(expected).with("childBean", childStringEqualTo("banana")).with("parentString",
                equalTo("strawberry")));
    }
    ...
    public void matchesItemInCollectionWithCustomMatcher() {
        ...
        ParentBean.Builder actual = parent().addToChildBeanList(child().childString("apple")).addToChildBeanList
                (child().childString("banana"));
    ...
    public void failsWhenCustomMatcherDoesNotMatchACollection() {
        ...
        assertThrows(AssertionError.class, () -> assertThat(actual, sameBeanAs(expected).with("childBeanList",
                hasItem(childStringEqualTo("kiwi")))));
    }
    ...
    public void matchesItemInMap() {
        ...
        assertThat(actual, sameBeanAs(expected).with("childBeanMap", hasEntry(equalTo("key"), childStringEqualTo
                ("banana"))));
    }
    ...
    public void failsWhenCustomMatcherDoesNotMatchAMap() {
        ...
        assertThrows(AssertionError.class, () -> assertThat(actual, sameBeanAs(expected).with("childBeanMap",
                hasEntry(equalTo("key"), childStringEqualTo("kiwi")))));
    }

    @Test
    public void failsWhenActualIsNull() {
        assertThrows(AssertionError.class, () -> MatcherAssert.assertThat(null, sameBeanAs(bean()).with("string",
                startsWith("field"))));
    }
}
