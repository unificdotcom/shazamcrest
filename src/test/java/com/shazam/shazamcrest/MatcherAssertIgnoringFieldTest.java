...
public class MatcherAssertIgnoringFieldTest {
    ...
    public void failsWhenBeanDoesNotMatchedEvenAfterIgnoringField() {
        ...
        assertThrows(AssertionFailedError.class, () -> assertThat(actual, sameBeanAs(expected).ignoring("string")));
    }

    @Test
    public void ignoresPrimitiveFields() {
        BeanWithPrimitives.Builder expected = beanWithPrimitives().beanByte((byte) 1).beanInt(1).beanChar('a')
                .beanShort((short) 2).beanLong(3).beanFloat(4).beanDouble(5).beanBoolean(true);
        BeanWithPrimitives.Builder actual = beanWithPrimitives().beanByte((byte) 2).beanInt(2).beanChar('b')
                .beanShort((short) 3).beanLong(4).beanFloat(5).beanDouble(6).beanBoolean(false);

        assertThat(actual, sameBeanAs(expected).ignoring("beanInt").ignoring("beanByte").ignoring("beanChar")
                .ignoring("beanShort").ignoring("beanLong").ignoring("beanFloat").ignoring("beanDouble").ignoring
                        ("beanBoolean"));
    }
    ...
    public void failsWhenBeanDoesNotMatchEvenAfterIgnoringFieldInNestedBean() {
        ...
        assertThrows(AssertionFailedError.class, () -> assertThat(actual, sameBeanAs(expected).ignoring("childBean" +
                ".childString")));
    }
    ...
    public void failsWhenBeanDoesNotMatchAfterIgnoringFieldsInBeansWhitinList() {
        ...
        assertThrows(AssertionFailedError.class, () -> assertThat(actual, sameBeanAs(expected).ignoring
                ("childBeanList.childString")));
    }
