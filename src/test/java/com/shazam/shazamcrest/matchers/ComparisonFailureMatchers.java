...
public class ComparisonFailureMatchers {
    ...
    public static Matcher<AssertionFailedError> expected(Matcher<String> expectedMatcher) {
        return new FeatureMatcher<AssertionFailedError, String>(expectedMatcher, "ComparisonFailure with expected " +
    ...
    public static Matcher<AssertionFailedError> actual(Matcher<String> actualMatcher) {
        return new FeatureMatcher<AssertionFailedError, String>(actualMatcher, "ComparisonFailure with actual " +
    ...
    public static Matcher<AssertionFailedError> message(Matcher<String> messageMatcher) {
        return new FeatureMatcher<AssertionFailedError, String>(messageMatcher, "ComparisonFailure with message " +
